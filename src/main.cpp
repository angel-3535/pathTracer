...
int main(int argc, char *argv[]) {
  ...
  world.add(std::make_shared<Sphere>(point3(0,0,-1.2)     ,0.5, mate_blue));
  world.add(std::make_shared<Sphere>(point3(1.2,0,0)      ,0.5, mate_red));
  world.add(std::make_shared<Sphere>(point3(-3,1,-3)      ,0.5, mate_red));

  world.add(std::make_shared<Sphere>(point3(0,  -.4,0.2)  ,0.1, mate_red));
  world.add(std::make_shared<Sphere>(point3(0.3,-.4,0.2)  ,0.1, mate_green));
  world.add(std::make_shared<Sphere>(point3(-.3,-.4,0.2)  ,0.1, mate_blue));

  world.add(std::make_shared<Sphere>(point3(-1,0,-1)    ,0.5, metal_red));
  world.add(std::make_shared<Sphere>(point3(-1.2,0,0)   ,0.5, metal_green));
